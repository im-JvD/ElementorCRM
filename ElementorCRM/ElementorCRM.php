...
add_action( 'elementor/loaded', function() {
    ...
    if ( ! ecrm_check_elementor_version() ) {
        return;
    }
...
function ecrm_admin_notice( string $message, string $type = 'error' ): void {
...
function ecrm_check_elementor_version(): bool {

    if ( ! defined( 'ELEMENTOR_VERSION' ) ||
         version_compare( ELEMENTOR_VERSION, ECRM_MIN_ELEMENTOR_VERSION, '<' ) ) {
